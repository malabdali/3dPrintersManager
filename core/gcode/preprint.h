...
class GCode::PrePrint : public GCodeCommand
{
    Q_OBJECT
private://fields
    int _fan_speed,_acceleration;
    bool _go_home,_e_absolute;
    double _e_position;
    bool _fan_speed_finished,_acceleration_finished,_e_absolute_finished,_go_home_finished,_e_position_finished;
public:
    explicit PrePrint(Device* device,int fanSpeed,int acceleration,double ePosition,bool goHome,bool EAbsolute);
